...
- [带权重且有限制最大区间数目](#带权重且有限制最大区间数目)
  - [1751. 最多可以参加的会议数目 II](#1751-最多可以参加的会议数目-ii)
- [合并区间](#合并区间)
  - [2580. 统计将重叠区间合并成组的方案数](#2580-统计将重叠区间合并成组的方案数)
- [前缀和优化](#前缀和优化)
  - [1997. 访问完所有房间的第一天](#1997-访问完所有房间的第一天)
- [排序+维护最值优化](#排序维护最值优化)
  - [2713. 矩阵中严格递增的单元格数](#2713-矩阵中严格递增的单元格数)
- [题目](#题目)
  - [1883. 准时抵达会议现场的最小跳过休息次数](#1883-准时抵达会议现场的最小跳过休息次数)
  - [312. 戳气球](#312-戳气球)
  - [1671. 得到山形数组的最少删除次数](#1671-得到山形数组的最少删除次数)
  - [39. 组合总和](#39-组合总和)
    - [322. 零钱兑换](#322-零钱兑换)
    - [2786. 访问数组中的位置使分数最大](#2786-访问数组中的位置使分数最大)
  - [466. 统计重复个数](#466-统计重复个数)
